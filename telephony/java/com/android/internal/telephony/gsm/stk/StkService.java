    ...
    private void handleRilMsg(RilMessage rilMsg) {
        ...
        case MSG_ID_PROACTIVE_COMMAND:
            ...
            if (cmdParams != null) {
                ...
                // for proactive commands that couldn't be decoded
                // successfully respond with the code generated by the
                // message decoder. Sometimes decoder could not even decode
                // the COMMAND DETAILS. In that case fill 0x00 for command
                // details. As per spec TS 102.223 section 6.8.1, the UICC shall
                // interpret a Terminal Response with a command number '00' as
                // belonging to the last proactive command.
    ...
    private void encodeOptionalTags(CommandDetails cmdDet,
        ...
        switch (AppInterface.CommandType.fromInt(cmdDet.typeOfCommand)) {
            ...
            case PROVIDE_LOCAL_INFORMATION:
                ...
                break;
            default:
                StkLog.d(this, "encodeOptionalTags() Unsupported Stk:" + cmdDet.typeOfCommand);
                break;
        }
    }
